...
public class ErrorConstant {
    ...
    public static final int ERR_CONFIG_MODEL_NOT_FIND_ACCESS_INFO = 4001010;
    public static final String ERR_CONFIG_MODEL_NOT_FIND_ACCESS_INFO_MSG = "未找到configModel对应accessKey相关信息";

    public static final int ERR_REQUEST_INVALID_DEVICE_CONTROL_MODEL_PARAM = 4001008;
    public static final String ERR_REQUEST_INVALID_DEVICE_CONTROL_MODEL_PARAM_MSG = "未找到需要控制的设备模型";
    // 4031 权限错误
    ...
    public static final int ERR_HTTP_REQUEST = 50011102;
    public static final String ERR_HTTP_REQUEST_MSG = "server http error";
